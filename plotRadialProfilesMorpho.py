...
morphoFraction = (nodeData.diskGasMass[0:nHalos])/(nodeData.spheroidGasMass[0:nHalos]+nodeData.diskGasMass[0:nHalos])
whereAreNaNs = np.isnan(morphoFraction);
morphoFraction[whereAreNaNs] = 0;
#morphoFraction = nodeData.diskGasMass[0:nHalos]/(nodeData.diskStellarMass[0:nHalos]+nodeData.spheroidStellarMass[0:nHalos]+1E-16)
#morphoFraction = nodeData.diskGasMass[0:nHalos]/(nodeData.nodeMass[0:nHalos])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]
	#print mask
print 'Number of Objects in bin 1', len(morphoFraction[mask]) 
if len(morphoFraction[mask] != 0): 	
	mean1 = np.mean(morphoFraction[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 2', len(morphoFraction[mask]) 
if len(morphoFraction[mask] != 0): 	
	mean2 = np.mean(morphoFraction[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 3', len(morphoFraction[mask]) 
if len(morphoFraction[mask] != 0): 	
	mean3 = np.mean(morphoFraction[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 4', len(morphoFraction[mask]) 
if len(morphoFraction[mask] != 0): 	
	mean4 = np.mean(morphoFraction[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 5', len(morphoFraction[mask]) 
if len(morphoFraction[mask] != 0): 	
	mean5 = np.mean(morphoFraction[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 6', len(morphoFraction[mask]) 
if len(morphoFraction[mask] != 0): 	
	mean6 = np.mean(morphoFraction[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 7', len(morphoFraction[mask]) 
if len(morphoFraction[mask] != 0): 	
	mean7 = np.mean(morphoFraction[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 8', len(morphoFraction[mask]) 
if len(morphoFraction[mask] != 0): 	
	mean8 = np.mean(morphoFraction[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 9', len(morphoFraction[mask]) 
if len(morphoFraction[mask] != 0): 	
	mean9 = np.mean(morphoFraction[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 10', len(morphoFraction[mask]) 
if len(morphoFraction[mask] != 0): 	
	mean10 = np.mean(morphoFraction[mask])
