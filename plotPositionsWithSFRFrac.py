...
#for i in range(tstep,tstep+1):
	...
	starFormation = (nodeData.diskStarFormationRate[0:nHalos]+nodeData.spheroidStarFormationRate[0:nHalos])/nodeData.nodeMass[0:nHalos]

	# Plot the inner 2 Mpc and color code them
	plimit=5.0	       # allowed distance from the center in Mpc
	title = 'galacticus_Salpeter_20905.hdf5 Halo Positions with SFR Fractional'
	fig = plt.figure()
