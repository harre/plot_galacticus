...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]
	#print mask
print 'Number of Objects in bin 1', len(starFormation[mask]) 
if len(starFormation[mask] != 0): 	
	mean1 = np.mean(starFormation[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 2', len(starFormation[mask]) 
if len(starFormation[mask] != 0): 	
	mean2 = np.mean(starFormation[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 3', len(starFormation[mask]) 
if len(starFormation[mask] != 0): 	
	mean3 = np.mean(starFormation[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 4', len(starFormation[mask]) 
if len(starFormation[mask] != 0): 	
	mean4 = np.mean(starFormation[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 5', len(starFormation[mask]) 
if len(starFormation[mask] != 0): 	
	mean5 = np.mean(starFormation[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 6', len(starFormation[mask]) 
if len(starFormation[mask] != 0): 	
	mean6 = np.mean(starFormation[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 7', len(starFormation[mask]) 
if len(starFormation[mask] != 0): 	
	mean7 = np.mean(starFormation[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 8', len(starFormation[mask]) 
if len(starFormation[mask] != 0): 	
	mean8 = np.mean(starFormation[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 9', len(starFormation[mask]) 
if len(starFormation[mask] != 0): 	
	mean9 = np.mean(starFormation[mask])
...
for i in range(nHalos):
	...
	mask[i] = True & pmask[i]	    
print 'Number of Objects in bin 10', len(starFormation[mask]) 
if len(starFormation[mask] != 0): 	
	mean10 = np.mean(starFormation[mask])
...
title = savepath+'SFR, galacticus_13076_1_manyoutputs.hdf5'
fig = plt.figure()
ax = fig.add_subplot(111)
ax.plot(plimit, mean, 'ro', c='#424242')
ax.axis([0,10.5,1E6,1E12])
ax.set_yscale('log')
